...
import 'package:booking_app/scr/widgets/icon_card.dart';
          ...
          child: Column(
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  IconCard(iconData: Icons.home, text: 'Home',),
                  IconCard(iconData: Icons.directions_bike, text: 'Parking',),
                  IconCard(iconData: Icons.directions, text: 'Adventures',),
                  IconCard(iconData: Icons.local_movies, text: 'Buzz',),
